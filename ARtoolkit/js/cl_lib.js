...
function excerpt(s,l)
//{if (s.length>l)s=s.substr(0,s.lastIndexOf(' ',l))+'...';return s;}
{
    if (s == undefined)return("undefined");
	//if(s.length>l)s = s.substr(0,s.lastIndexOf(' ',l))+'...';
...
function getAndroidVersion(ua) {ua = (ua || navigator.userAgent).toLowerCase(); var match = ua.match(/android\s([0-9\.]*)/);return match ? match[1] : false;};
function getLanguage(){var userLang = navigator.language || navigator.userLanguage; alert ("The language is: " + userLang);}
